          ...
          <table className="min-w-full divide-y divide-cloud text-sm">
            <thead className="bg-paper-mist">
              <tr>
                ...
                <th className="px-4 py-3 text-left font-medium text-steel">Terminées</th>
                <th className="px-4 py-3 text-left font-medium text-steel">En retard</th>
            ...
            <tbody className="divide-y divide-ash/60">
              ...
              {activites.map((a) => (
                <tr key={a.id} className="hover:bg-paper-mist">
                  ...
                  <td className="px-4 py-3 text-electric-blue">{a.nb_terminees}</td>
