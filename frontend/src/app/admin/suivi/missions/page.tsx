...
import type { ExecutionStatutFilter, Mission } from "@/types";
...
export default function SuiviMissionsPage() {
  return <SuiviMissionsContent />;
}

function SuiviMissionsContent() {
  ...
  const queryKey = ["missions", DEFAULT_ANNEE, statut];
  ...
  return (
    <>
      <PageHeader
        title="Missions"
        description="Suivi des missions avec date de réalisation"
        actions={
          canWrite && !showForm ? (
      ...
      <ConfirmDialog
        ...
        description="Cette mission sera définitivement supprimée."
