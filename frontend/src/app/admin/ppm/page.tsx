  ...
  return (
    <AdminShell>
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-charcoal">Marchés PPM</h1>
        ...
        {showForm && canWrite && (
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div>
                <label className="mb-1 block text-sm text-steel">N°</label>
                <input
                  value={form.numero}
              ...
              <div className="sm:col-span-2">
                <label className="mb-1 block text-sm text-steel">Intitulé</label>
                <input
                  required
                  value={form.intitule}
              ...
              <div>
                <label className="mb-1 block text-sm text-steel">Mode passation</label>
                <input
              ...
              <div>
                <label className="mb-1 block text-sm text-steel">Statut</label>
                <select
                  value={form.statut}
                  onChange={(e) =>
              ...
              <div>
                <label className="mb-1 block text-sm text-steel">Montant estimé</label>
                <input
                  type="number"
                  min="0"
              ...
              <div>
                <label className="mb-1 block text-sm text-steel">Montant attribué</label>
                <input
                  type="number"
                  min="0"
              ...
              <div>
                <label className="mb-1 block text-sm text-steel">Date marché</label>
                <input
                  type="date"
          ...
          <table className="min-w-full divide-y divide-cloud text-sm">
            <thead className="bg-paper-mist">
              <tr>
                ...
                <th className="px-4 py-3 text-left font-medium text-steel">Intitulé</th>
                <th className="px-4 py-3 text-left font-medium text-steel">Statut</th>
                <th className="px-4 py-3 text-left font-medium text-steel">Montant estimé</th>
              ...
              {items.map((item) => (
                <tr key={item.id} className="hover:bg-paper-mist">
                  ...
                  <td className="px-4 py-3">
                    <span className="rounded-full bg-paper-mist px-2 py-0.5 text-xs text-electric-blue">
